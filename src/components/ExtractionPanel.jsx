            ...
            <div className="bg-white dark:bg-slate-800 rounded p-4 border border-slate-200 dark:border-slate-700 shadow-sm">
                ...
                <div className="grid grid-cols-2 gap-2">
                    ...
                    <button
                        ...
                        className="col-span-2 bg-slate-600 hover:bg-slate-700 dark:bg-slate-700 dark:hover:bg-slate-600 text-white text-xs font-medium py-1.5 px-3 rounded flex items-center justify-center gap-2 transition-colors shadow-sm"
