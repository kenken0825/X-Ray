...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 text-slate-900 dark:text-white p-2 transition-colors duration-300 flex flex-col justify-center">
      <div className="w-full max-w-md mx-auto glass rounded-xl shadow-xl overflow-hidden">
        <header className="px-4 py-3 border-b border-slate-200/50 dark:border-slate-700/50 flex justify-between items-center backdrop-blur-md bg-white/30 dark:bg-slate-900/30">
        ...
        <main className="p-4 space-y-4">
          ...
          <section className="border-t border-slate-200/50 dark:border-slate-700/50 pt-4">
            <ExtractionPanel
